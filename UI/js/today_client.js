...
function books(book_id, car_number, from_location, to_location, price){
    ...
    <input type="text" maxlength="20" rows ="2" cols = "33" name="customer_name" placeholder="Client Name"><br><br>
    <input type="number" maxlength="20" rows ="2" cols = "33" name="customer_number" placeholder="Client Phone Number"><br><br>

    <input type="number" maxlength="20" rows ="2" cols = "33" name="quantiy" placeholder="How many seats"><br><br>
    <input type="date" maxlength="20" rows ="2" cols = "33" name="date_when" placeholder="Date"><br><br>
...
document.getElementById("search").addEventListener("click",
    function modifyEntry(event){
        event.preventDefault();
        let url = "https://senditparcel.herokuapp.com/api/admin/v2/create/passenger";
        // console.log(modify)
            ...
            let customer_name = document.forms["modify"]["customer_name"].value;
            let customer_number = document.forms["modify"]["customer_number"].value;
            let quantiy = document.forms["modify"]["quantiy"].value;
            let date_when = document.forms["modify"]["date_when"].value;
            let amount = price * quantiy;

            let data = {car_number:car_number, from_location:from_location, to_location:to_location, price:price, 
                        customer_name, customer_number, quantiy:quantiy,date_when:date_when, amount:amount}
            console.log(data)
            fetch(url, {
            ...
            .then((data)=>{
                ...
                window.location.replace("deskpay.html")
