...
function fetchprice(event){
    ...
    let data = {first_name:first_name, last_name:last_name, email:email, permit_number:permit_number, city:city, age:age, salary:salary, nation_id:nation_id, sex:sex, phone_number:phone_number, image:image};
